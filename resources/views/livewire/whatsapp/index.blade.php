<div class="grid grid-cols-1 md:grid-cols-5 gap-5 -mt-2">
    <x-card title="Whatsapp api" shadow separator class="col-span-1 md:col-span-2">
        ...
        <div class="">
            ...
            <div class="flex justify-center items-center mt-5">
                <img src="{{ $qr }}" alt="QR Code" class="rounded-lg shadow-lg w-72 border border-base-300">
            </div>
            ...
            @if ($sesion)
            <div class="flex  items-center">
                <x-button label="Ganti Nomor" wire:click="dc" class="btn btn-error btn-sm mt-4 mx-auto" spinner />
    ...
    <x-card title="Pesan" shadow separator class="col-span-1 md:col-span-3">
        ...
        <x-table :headers="$headers" :rows="$pesan" striped class="mt-5" with-pagination per-page="perPage"
            ...
            <a class="link link-info" href="{{ route('nasabah.show', $pesan->nasabah->id) }}" wire:navigate>{{
                $pesan->nasabah->nama }}</a>
            @endscope
